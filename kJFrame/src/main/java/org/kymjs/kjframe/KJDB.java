...
public class KJDB {
     ...
     * @return
     * <br>
     * 示例：select count(1) from table_xx
     */
    public int queryCountBySql(String sql,String[] selectionArgs,Class<?> clazz){
        checkTableExist(clazz);
        Cursor cursor = null;
        try{
     ...
     * 示例：select count(1) from table_xx
     */
    public  int queryCountBySql(String sql,String[] selectionArgs){
        Cursor cursor = null;
        try{
            cursor = db.rawQuery(sql, selectionArgs);
            if(cursor != null && cursor.moveToFirst()){
     ...
     * @return
     */
    public List<Map<String,String>> queryBySql(String sql,String[] selectionArgs,Class<?> clazz){
        checkTableExist(clazz);
     ...
     * @return
     */
    public  List<Map<String,String>> queryBySql(String sql,String[] selectionArgs){
        List<Map<String,String>> list = null;
        Cursor cursor = db.rawQuery(sql, selectionArgs);
        if(cursor != null && cursor.moveToFirst()){
            list = new ArrayList<Map<String,String>>();
     ...
     * @param sql
     */
    public void deleteSQL(String sql,Class<?> clazz) {
        checkTableExist(clazz);
        db.execSQL(sql);
    }
     ...
     * 示例：select count(1) from table_xx
     */
    public  List<String> queryListString(String sql,String[] selectionArgs){
